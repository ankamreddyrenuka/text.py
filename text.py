...
# Set the correct Tesseract path (Make sure to replace this with your actual path)
pytesseract.pytesseract.tesseract_cmd = r"/usr/bin/tesseract"  # Adjust this path as per your system
